...
export class WeatherAgentService extends Effect.Service<WeatherAgentService>()(
  'app/WeatherAgentService',
  {
    dependencies: [WeatherToolService.Default, WeatherScorerService.Default],
    effect: Effect.gen(function* () {
      const { weatherTool } = yield* WeatherToolService;
      const scorers = yield* WeatherScorerService;
